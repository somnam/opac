...
class RefreshShelvesUseCase:
    ...
    async def execute(self, profile: Profile) -> None:
        ...
        gateway_shelves = await self._repository.gateway.shelf.search(profile)
        ...
        with self._repository.unit_of_work():
            ...
            if result:
                if result.new:
                    ...
                    self._repository.shelf.create_many(new_shelfs)
                ...
                if result.updated:
                    ...
                    self._repository.shelf.update_many(updated_shelfs)
                ...
                if result.deleted:
                    ...
                    self._repository.shelf.delete_many(deleted_shelfs)
